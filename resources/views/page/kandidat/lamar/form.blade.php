  ...
  <div class="page-heading">
    ...
    <section class="section">
      <div class="card">
        <h5 class="card-header">Form Lamaran Kerja - Posisi : <u>{{$dt->nama_jabatan}}</u></h5>
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <form id="lamarForm" enctype="multipart/form-data" method="post">
                  ...
                  <div class="tab-content px-0 mt-0">
                    <div class="tab-pane fade show active" id="tagihan-belum-bayar">
                      <input type="" hidden="" value="{{$dt->id_lowongan}}" name="id_lowongan">
              ...
              <div class="col-lg-12 mb-2">
                ...
                <?php  
                if ($profil->foto == NULL) {
                  $foto = asset('thumbnail.png');
                }else{
                  $foto = asset('foto_profil/'.$profil->foto);
                }
                ?>
                <img src="{{$foto}}" alt="foto profil" class="d-block rounded img_preview" height="100" width="100" id="uploadedAvatar" />
