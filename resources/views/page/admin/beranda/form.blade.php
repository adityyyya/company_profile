 <div class="row" id="contentForm">
  <div class="col-12">
    <div class="form-group">
      ...
      <input type="" hidden="" id="id_beranda" name="id_beranda">
  ...
  <div class="col-12">
    <div class="form-group">
      <label class="col-form-label">Background Section (background belakang) <span class="text-danger mandatory"></span></label>
